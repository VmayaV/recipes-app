...
const RightArrow = ({ next, disabled }: RightArrowProps) => {
    return (

        <button onClick={next} className={`flex md:visible invisible ${disabled ? "disabled-nav-button" : "enabled-nav-button"}`} disabled={disabled}>
