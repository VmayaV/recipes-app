        ...
        <main className="">
            <header className="flex items-stretch flex-col md:flex-row">
                <div className="basis-full md:basis-1/3">
                    <div className="bg-dark-blue text-white px-5 pt-16.5 pb-12.5 md:px-20">
                        <div className="">
                            nav
                        </div>
                        <h1 className="text-white uppercase my-4">Klassisk burger m. hjemmelavet pomfritter
                        </h1>
            ...
            <section className="flex flex-col md:flex-row">
                <div className="bg-light-blue basis-full md:basis-1/3"><h2 className="text-dark-blue uppercase">Ingredienser</h2></div>


                <div className="basis-full md:basis-2/3">
                    <h2 className="text-dark-blue uppercase">Introduktion</h2>
                    <div>
                    ...
                    <div className="flex">
                        {/* tags */}
                        <div className='bg-dark-gray mr-2'>Hovedretter</div>
                        <div className='bg-dark-gray mr-2'>Amerikansk</div>
                        <div className='bg-dark-gray mr-2'>Junk food</div>
                        <div className='bg-dark-gray mr-2'>Frokost</div>
                        <div className='bg-dark-gray mr-2'>Nem aftensmad</div>
                    </div>
                    <div>
                        <div>Næringsindhold</div>
                        <table className="table-auto">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>ENERGIFORDELING</th>
                                    <th>NÆRINGSINDHOLD PR. 100G
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
