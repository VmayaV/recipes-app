...
import Nutritions from "../components/details/Nutritions";
        ...
        <main className="font-gotham">
            <header className="flex items-stretch flex-col md:flex-row">
                <div className="bg-dark-blue basis-full md:basis-1/3 flex flex-col justify-between text-white px-5 pt-16.5 pb-12.5 md:px-20">
                    ...
                    <div>
                        <h1 className="text-white uppercase my-4 font-veener-two text-6xl">
                ...
                <div className="basis-full md:basis-2/3">
                    <img className="min-w-full" src={pictures[0].url} />
                </div>
            </header>

            <section className="flex flex-col md:flex-row">
                <div className="bg-light-blue basis-full md:basis-1/3 px-5 py-8 md:px-20 md:py-14">
                    <h2 className="text-dark-blue uppercase font-veener-two text-lg py-2 text-3xl.5 leading-9">
                        Ingredienser
                    </h2>
                </div>
                ...
                <div className="basis-full md:basis-2/3 px-5 py-8 md:px-10 md:py-14">
                    <h2 className="text-dark-blue uppercase font-veener-two text-3xl.5 leading-9 py-2">Introduktion</h2>
            ...
            <ul className="flex justify-center">
                <li>
                    <a href="#" className="flex p-4 items-center">
                        ...
                        <span className="invisible md:visible pl-2">Facebook</span>
                    </a>
                </li>
                <li>
                    <a href="#" className="flex p-4 items-center">
                        ...
                        <span className="invisible md:visible pl-2">Youtube</span>
                    </a>
                </li>
                <li>
                    <a href="#" className="flex p-4 items-center">
                        ...
                        <span className="invisible md:visible pl-2">Instagram</span>
                    </a>
                </li>
            </ul>
        </footer>
